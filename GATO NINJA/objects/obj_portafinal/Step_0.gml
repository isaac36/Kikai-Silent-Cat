...
if(pode_abrir)and(obj_gato.chavefinal)and(obj_gato.BOTAO_ATAQUE2)and(!abriu)and(obj_tela_escura.image_alpha<=0){abriu=true;audio_play_sound(sfx_porta_de_ferro,0,false);}
